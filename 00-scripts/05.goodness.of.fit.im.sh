...
#global variable
model="../im.simul.ABC.txt" #pick-up the best model
FOLDER=./02-results/ppc.im
NREPS=5000
...
# Launch Rscript
Rscript ../../00-scripts/rscript/04.goodness.of.fit.im.R "$model" "$POP1" "$POP2" "$NREPS" "$NLOC" "$repeat"
