...
res=model_selection_abc_nnet(target=obs, x=x, sumstat=z, tol=500/(nrow(M.full)), noweight=F, rejmethod=F, nb.nnet=50, size.nnet=15, output=paste("02-results/robustess.",target, "_",lowbnd,sep=""))
